...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_green,nobold,nounderscore,noitalics] #[fg=$onedark_white,bg=$onedark_green,nobold] #I   #W #[fg=$onedark_visual_grey,bg=$onedark_green,nobold,nounderscore,noitalics]"
